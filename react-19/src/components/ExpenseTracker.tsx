      ...
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-lg">
        ...
        <div className="space-y-4 mb-6">
          ...
          <button
            ...
            className="bg-purple-600 text-white w-full px-4 py-2 shadow-md hover:bg-purple-700 transition duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500"
          >
            Add Expense
          </button>
        </div>
