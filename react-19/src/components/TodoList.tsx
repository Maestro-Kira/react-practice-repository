      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <div className="flex items-center mb-4">
          ...
          <button
            ...
            className="bg-blue-500 text-white px-4 py-2 rounded-r-lg hover:bg-blue-600 focus:outline-none focus:right-2 focus:ring-blue-500"
          >
            Add
          </button>
        </div>
            ...
            >
              <div className="flex items-center">
                <input
                  ...
                  className="mr-2 h-5 w-5 accent-rose-600"
                />
                <span
                  className={`${
                    todo.completed
